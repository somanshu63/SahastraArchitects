...
export const headerImagesArray = [
  {
    image: theWhiteVilla1,
...

  {
    ...
    projects: [
...

      {
        ...
        location: "New Tehri",
        image: [theLakeViewVilla, theLakeViewVilla],
        latitude: 30.3739,
        longitude: 78.4325,
        year: 2017,
        size: "",
      ...
      {
        name: "The Blue Heaven Residence",
...

      {
        ...
        location: "New Delhi",
        image: [theLuxuriousHouse, theLuxuriousHouse],
        latitude: 28.6139,
        longitude: 77.2088,
        year: 2019,
        size: "",
      ...
      {
        name: "Sun n Soil Backpackers Hostel",
